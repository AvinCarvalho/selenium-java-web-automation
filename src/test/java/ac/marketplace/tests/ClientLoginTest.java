...
public class TestLoginTest extends BaseTest {
     @Test(description = "Validation of testingapp Test Login with Valid Credentials", dataProviderClass = TestLoginData.class,
      ...
      @Test(description = "Validation of testingapp Test Login with Invalid Credential", dataProviderClass = TestLoginData.class,
        ...
        @Test(description = "Validation of testingapp Test Login with Invalid email", dataProviderClass = TestLoginData.class,
                dataProvider = "Invalid_Email",groups = {"sanity","acceptance","system"})
        public void InvalidEmail(String EmailId, String Password) {
          new TestLoginPage().LogIn(EmailId, Password);
            Assert.assertNotSame(driver.get().getCurrentUrl(),Test_URL,"URL is not matching");
        }
        @Test(description = "Validation of testingapp Test Login with Blank Fields", dataProviderClass = TestLoginData.class,
        ...
        @Test(description = "Validation of testingapp Test Login with Blank PasswordField", dataProviderClass = TestLoginData.class,
