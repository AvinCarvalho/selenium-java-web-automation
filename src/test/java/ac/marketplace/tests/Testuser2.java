...
public class TestLoginTest extends BaseTest {
        ...
        @Test(description = "Validation of testingapp Test Login with Invalid Credential", dataProviderClass = TestLoginData.class,
        ...
        public void LoginInPageWithInvalidCredential(String EmailId, String Password)  {
            new TestLoginPage().LogIn(EmailId, Password);
            Assert.assertNotSame(driver.get().getCurrentUrl(),SUPPILER_URL,"URL is not matching");
        }
        @Test(description = "Validation of testingapp Test Login with less dino password", dataProviderClass = TestLoginData.class,
        ...
        @Test(description = "Validation of testingapp Test Login with Invalid email",
                dataProviderClass = TestLoginData.class, dataProvider = "Invalid_Email",groups = {"sanity","acceptance","system"})
        public void InvalidEmail(String EmailId, String Password) {
            new TestLoginPage().LogIn(EmailId, Password);
            Assert.assertNotSame(driver.get().getCurrentUrl(),SUPPILER_URL,"URL is not matching");
        }

        @Test(description = "Validation of testingapp Test Login with Blank Fields",
                dataProviderClass = TestLoginData.class, dataProvider = "Blank_Fields",groups = {"sanity","acceptance","system"})
        public void BlankFields(String EmailId, String Password) {
            new TestLoginPage().LogIn(EmailId, Password);
            Assert.assertNotSame(driver.get().getCurrentUrl(),SUPPILER_URL,"URL is not matching");
        }

        @Test(description = "Validation of testingapp Test Login with Blank EmailField", dataProviderClass = TestLoginData.class,
                dataProvider = "Blank_EmailField",groups = {"sanity","acceptance","system"})
        public void BlankEmailField(String EmailId, String Password) {
            new TestLoginPage().LogIn(EmailId, Password);
            Assert.assertNotSame(driver.get().getCurrentUrl(),SUPPILER_URL,"URL is not matching");
        }
        @Test(description = "Validation of testingapp Test Login with Blank PasswordField",
                dataProviderClass = TestLoginData.class,dataProvider = "Blank_Password",groups = {"sanity","acceptance","system"})
